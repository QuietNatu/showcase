  ...
  forbidden: [
    ...
    },
    {
      ...
      from: {
        path: '^(apps|packages)',
        pathNot: [
          '.(spec|test|stories|vrt).(js|mjs|cjs|ts|ls|coffee|litcoffee|coffee.md)$',
          'test',
        ],
      },
      to: {
...

    {
      ...
      comment: 'Code outside of features should not depend on features',
      severity: 'error',
...

    {
      ...
      from: {},
      to: {
        path: '.vrt.(js|jsx|mjs|cjs|ts|tsx|ls|coffee|litcoffee|coffee.md)$',
      },
    },
  ],
  options: {
